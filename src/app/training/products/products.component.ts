  ...
  */
  ...
  onLoadMore() {
    ...
    if(!this.AllResourcesLoaded){
        ...
        this.get_all_posts(this.page,this.limit,true);
    }
  }
   ...
   * 
  */ 
  get_all_posts(page?:any, limitChanged?:any,LoadMore?:any) {
    ...
    this.cond.ProductSlug = this.ProductSlug;
    
    // get forum lists
    if(!LoadMore){
        this.AllResources = [];
    }
    this.ResourcesService.getProductPosts(this.cond).subscribe(res => {
      if (res && res.data) {
